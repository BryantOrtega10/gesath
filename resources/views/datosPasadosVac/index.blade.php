...
<div class="row">
    <div class="col-12">
        <h1>Carga datos pasados vacaciones</h1>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="cajaGeneral">
            <form method="POST" id="" autocomplete="off" class="formGeneral" action="/datosPasadosVac/subirArchivo" enctype="multipart/form-data">
                @csrf
        ...
        <table class="table table-hover table-striped ">
            ...
            @foreach ($cargasDatosPasados as $cargaDatoPasado)
                <tr>
                    ...
                    <td><a href="/datosPasadosVac/verCarga/{{$cargaDatoPasado->idCargaDatosPasados}}">Ver carga</a></td>
                </tr>
            @endforeach
        </table>
    </div>
