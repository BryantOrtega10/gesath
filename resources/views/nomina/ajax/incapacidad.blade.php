...
<form action="/nomina/insertarNovedadIncapacidad" method="POST" class="formGeneral" id="formDatosNovedad" autocomplete="off">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="form-group busquedaPop"  id="busquedaCodDiagnostico">
                <label for="codigoDiagnostico" class="control-label">Codigo de diagnostico:</label>
        ...
        <div class="col-3">
            <div class="form-group">
                <label for="numIncapacidad" class="control-label">Numero incapacidad:</label>
