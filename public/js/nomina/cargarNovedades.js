...
$(document).ready(function(){
        ...
        if(idNomina != ""){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $(".respTipoNomina").html("Perido: " + data.periodoNomina);
    ...
    $("body").on("change", "#tipo_novedad",function(){
        ...
        if(idTipo_novedad != ""){
            ...
            $.ajax({
                type:'GET',
                url: "/nomina/cargarFormxTipoNov/" + idTipo_novedad,
                success:function(data){
                    $("#cargando").css("display", "none");
                    if(data.tipo == 1){
    ...
    $("body").on("change", "#concepto", function(e){        
        ...
        if ($('#tipoAfiliacion').length > 0) {
            ...
            $.ajax({
                type:'GET',
                url: '/nomina/tipoAfiliacionxConcepto/'+$("#tipo_novedad").val()+'/'+concepto,
                success:function(data){
                    $("#cargando").css("display", "none");
    ...
    $("body").on("change", "#tipoAfiliacion", function(e){
        ...
        if ($('#terceroEntidad').length > 0) {
            ...
            $.ajax({
                type:'GET',
                url: '/nomina/entidadxTipoAfiliacion/'+tipoAfiliacion+'/'+idEmpleado,
                success:function(data){
                    $("#cargando").css("display", "none");
