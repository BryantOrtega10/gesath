...
$(document).ready(function() {
    ...
    $("#addCalendario").click(function(e) {
        e.preventDefault();
        cargando();
        $.ajax({
            type: 'GET',
            url: "/calendario/getFormAdd",
    ...
    $(".editar").click((e) => {
        ...
        $.ajax({
            type: 'GET',
            url: `/calendario/datosCalendarioXId/${idCalendario}`,
            success: function(data) {
                $("#cargando").css("display", "none");
                $(".respForm[data-para='calendarios']").html(data);
                $('#calendariosModal').modal('show');
    ...
    $("body").on("submit", ".formEdit", function(e) {
        ...
        cargando();
        $(".close").trigger('click');
        const idEditar = $("#idCalendario").val();
        var formdata = new FormData(this);
        $.ajax({
            type: 'POST',
    ...
    $("body").on("click", ".detalle", (e) => {
        ...
        $.ajax({
            type: 'GET',
            url: `/calendario/detalleCalendario/${idCalendario}`,
            success: function(data) {
                $("#cargando").css("display", "none");
                $(".respForm[data-para='calendarios']").html(data);
                $('#calendariosModal').modal('show');
    ...
    $("body").on("click", ".eliminar", (e) => {
        ...
        if (confirmar) {
            $.ajax({
                type: 'POST',
                url: `/calendario/eliminarCalendario/${idCalendario}`,
                cache: false,
                processData: false,
                contentType: false,
                success: function(data) {
